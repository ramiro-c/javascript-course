    ...
    var Popover = (function (_Tooltip) {
      ...
      function Popover() {
        ...
        return possibleConstructorReturn(
          this,
          (Popover.__proto__ || Object.getPrototypeOf(Popover)).apply(
            this,
            arguments
          )
        );
    ...
    var BaseInput = (function (_Base) {
      ...
      function BaseInput($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (BaseInput.__proto__ || Object.getPrototypeOf(BaseInput)).call(
            this,
            $element,
      ...
      createClass(BaseInput, [
        {
          ...
          value: function dispose(dataKey) {
            get(
              BaseInput.prototype.__proto__ ||
                Object.getPrototypeOf(BaseInput.prototype),
              "dispose",
              this
            ).call(this, dataKey);
        ...
        },
        {
          ...
          value: function findMdbLabel() {
            ...
            try {
              for (
                var _iterator = this.config.label.selectors[Symbol.iterator](),
                  _step;
        ...
        },
        {
          ...
          value: function _rejectWithoutRequiredClasses() {
            ...
            try {
              for (
                var _iterator3 = this.config.requiredClasses[Symbol.iterator](),
                  _step3;
                ...
                if (requiredClass.indexOf("||") !== -1) {
                  ...
                  try {
                    for (
                      var _iterator4 = oneOf[Symbol.iterator](), _step4;
    ...
    var BaseSelection = (function (_BaseInput) {
      ...
      function BaseSelection($element, config, properties) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (
            BaseSelection.__proto__ || Object.getPrototypeOf(BaseSelection)
          ).call(
            this,
            $element,
            $.extend(true, {}, Default, config),
    ...
    var Checkbox = (function (_BaseSelection) {
      ...
      function Checkbox($element, config) {
        var properties =
          arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : { inputType: NAME, outerClass: NAME };
        ...
        [
          {
            ...
            value: function dispose() {
              ...
              get(
                Checkbox.prototype.__proto__ ||
                  Object.getPrototypeOf(Checkbox.prototype),
                "dispose",
                this
              ).call(this, dataKey);
            },
    ...
    var CheckboxInline = (function (_Checkbox) {
      ...
      function CheckboxInline($element, config) {
        ...
        return possibleConstructorReturn(
          this,
          (
            CheckboxInline.__proto__ || Object.getPrototypeOf(CheckboxInline)
          ).call(
            this,
            $element,
            $.extend(true, {}, Default, config),
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                CheckboxInline.prototype.__proto__ ||
                  Object.getPrototypeOf(CheckboxInline.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
            },
    ...
    var CollapseInline = (function (_Base) {
      ...
      function CollapseInline($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (
            CollapseInline.__proto__ || Object.getPrototypeOf(CollapseInline)
          ).call(this, $element, $.extend(true, {}, Default, config))
        );
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                CollapseInline.prototype.__proto__ ||
                  Object.getPrototypeOf(CollapseInline.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
              this.$bmdFormGroup = null;
  ...
  var File = (function ($) {
    ...
    var File = (function (_BaseInput) {
      ...
      function File($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (File.__proto__ || Object.getPrototypeOf(File)).call(
            this,
            $element,
            $.extend(
              true,
  ...
  var Radio = (function ($) {
    ...
    var Radio = (function (_BaseSelection) {
      ...
      function Radio($element, config) {
        ...
        return possibleConstructorReturn(
          this,
          (Radio.__proto__ || Object.getPrototypeOf(Radio)).call(
            this,
            $element,
            $.extend(
              true,
        ...
        [
          {
            ...
            value: function dispose() {
              ...
              get(
                Radio.prototype.__proto__ ||
                  Object.getPrototypeOf(Radio.prototype),
                "dispose",
                this
              ).call(this, dataKey);
            },
  ...
  var RadioInline = (function ($) {
    ...
    var RadioInline = (function (_Radio) {
      ...
      function RadioInline($element, config) {
        ...
        return possibleConstructorReturn(
          this,
          (RadioInline.__proto__ || Object.getPrototypeOf(RadioInline)).call(
            this,
            $element,
            $.extend(true, {}, Default, config),
            properties
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                RadioInline.prototype.__proto__ ||
                  Object.getPrototypeOf(RadioInline.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
            },
    ...
    var BaseFormControl = (function (_BaseInput) {
      ...
      function BaseFormControl($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (
            BaseFormControl.__proto__ || Object.getPrototypeOf(BaseFormControl)
          ).call(this, $element, $.extend(true, Default, config))
        );
  ...
  var Switch = (function ($) {
    ...
    var Switch = (function (_Checkbox) {
      ...
      function Switch($element, config) {
        ...
        return possibleConstructorReturn(
          this,
          (Switch.__proto__ || Object.getPrototypeOf(Switch)).call(
            this,
            $element,
            $.extend(true, {}, Default, config),
            properties
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                Switch.prototype.__proto__ ||
                  Object.getPrototypeOf(Switch.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
            },
  ...
  var Textarea = (function ($) {
    ...
    var Textarea = (function (_BaseFormControl) {
      ...
      function Textarea($element, config) {
        ...
        return possibleConstructorReturn(
          this,
          (Textarea.__proto__ || Object.getPrototypeOf(Textarea)).call(
            this,
            $element,
            $.extend(
              true,
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                Textarea.prototype.__proto__ ||
                  Object.getPrototypeOf(Textarea.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
            },
  ...
  var BaseLayout = (function ($) {
    ...
    var BaseLayout = (function (_Base) {
      ...
      function BaseLayout($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (BaseLayout.__proto__ || Object.getPrototypeOf(BaseLayout)).call(
            this,
            $element,
            $.extend(true, {}, Default, config),
            properties
      ...
      createClass(BaseLayout, [
        {
          ...
          value: function dispose(dataKey) {
            get(
              BaseLayout.prototype.__proto__ ||
                Object.getPrototypeOf(BaseLayout.prototype),
              "dispose",
              this
            ).call(this, dataKey);
            this.$container = null;
  ...
  var Drawer = (function ($) {
    ...
    var Drawer = (function (_BaseLayout) {
      ...
      function Drawer($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (Drawer.__proto__ || Object.getPrototypeOf(Drawer)).call(
            this,
            $element,
            $.extend(true, {}, Default, config)
          )
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                Drawer.prototype.__proto__ ||
                  Object.getPrototypeOf(Drawer.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
              this.$toggles = null;
  ...
  var Autofill = (function ($) {
    ...
    var Autofill = (function (_Base) {
      ...
      function Autofill($element, config) {
        ...
        var _this = possibleConstructorReturn(
          this,
          (Autofill.__proto__ || Object.getPrototypeOf(Autofill)).call(
            this,
            $element,
            $.extend(true, {}, Default, config)
          )
        ...
        [
          {
            ...
            value: function dispose() {
              get(
                Autofill.prototype.__proto__ ||
                  Object.getPrototypeOf(Autofill.prototype),
                "dispose",
                this
              ).call(this, DATA_KEY);
            },
    ...
    var BootstrapMaterialDesign = (function () {
      function BootstrapMaterialDesign($element, config) {
        ...
        try {
          ...
          for (
            var _iterator = this.config.instantiation[Symbol.iterator](), _step;
            !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
            _iteratorNormalCompletion = true
          ) {
            _loop();
